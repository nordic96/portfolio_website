...
import { CertificationSchema, ICertificate } from "../../../models/certification";
...
export async function GET() {
    ...
    try {
        ...
        for (let doc of certificates) {
            schemaUtils.validateSchemaAndPush<ICertificate>(CertificationSchema, doc, validatedCertificates);
        }
    } catch (error) {
