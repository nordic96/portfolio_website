...
export default function HeroSection() {
  return (
    <section className="relative h-[90dvh] max-sm:h-dvh flex flex-col items-center justify-center bg-white px-6 md:px-12">
      ...
      <div className="container max-w-4xl mx-auto text-center flex flex-col items-center gap-8 md:gap-12 z-999">
        ...
        <div className={'flex flex-col mt-40 max-sm:mt-15 gap-8 md:gap-12'}>
          {/* Greeting */}
