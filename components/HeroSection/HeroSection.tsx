  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center bg-white px-6 md:px-12">
      <div className="container max-w-4xl mx-auto text-center flex flex-col items-center gap-8 md:gap-12">
        ...
        <div className="w-32 h-32 md:w-40 md:h-40 lg:w-52 lg:h-52 rounded-full bg-gray-100 border-4 border-[#77dd87] shadow-xl shadow-[#77dd87]/20" />

        {/* Greeting */}
        <p className="text-xl md:text-2xl font-normal text-[#77dd87]">
          Hi, I'm Stephen Ko 👋
        </p>

        {/* Headline */}
        <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold text-[#2D2D2D] leading-tight">
